 # Skapad av: Jarryd Martino, maj 2025
    
    # Syfte: Skapa ett omfattande PowerShell-skript som utför en djupgående säkerhetsrevision och automatiskt härdar en Windows-server enligt avancerade säkerhetsstandarder.
    ...
    # Förvöntade resultat:
    # Servern är fullt härdad (firewall, Defender, användare, tjänster, kryptering), en detaljerad loggfil skapas, och administratören får en sammanfattning i konsolen.
